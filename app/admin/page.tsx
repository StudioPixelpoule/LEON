...
// Types
type AdminView = 'dashboard' | 'scan' | 'posters' | 'transcode' | 'stats' | 'watching'
        ...
        <nav className={styles.sidebar}>
          ...
          <div className={styles.nav}>
            ...
            <div className={styles.navGroup}>
              ...
              <button
                className={`${styles.navItem} ${view === 'watching' ? styles.active : ''}`}
    ...
    <div className={styles.dashboard}>
      ...
      <div className={styles.quickActions}>
        ...
        >
          ...
          <div className={styles.quickActionContent}>
            <p className={styles.quickActionTitle}>Qui regarde ?</p>
            <p className={styles.quickActionDesc}>
...
function WatchingView() {
  const [data, setData] = useState<WatchingData | null>(null)
  const [loading, setLoading] = useState(true)
  ...
  function formatTime(iso: string): string {
    ...
    return h < 24 ? `Il y a ${h}h` : new Date(iso).toLocaleDateString('fr-FR', { day: 'numeric', month: 'short' })
  }
  ...
  return (
    <div className={styles.section}>
      <div className={styles.sectionHeader}>
        <div>
          <h1 className={styles.sectionTitle}>Qui regarde ?</h1>
          <p className={styles.sectionDesc}>Suivi en temps réel des visionnages</p>
        </div>
        <button className={styles.btnIcon} onClick={loadData}><RefreshCw size={18} /></button>
      </div>
